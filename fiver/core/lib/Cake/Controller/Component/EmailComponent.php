 ...
 */
	public function send($content = null, $template = null, $layout = null) {
		...
		$headers = array('X-Mailer' => Configure::read('site.name'));
		...
		if ($sent) {
			CakeLog::write('email', 'S, ' . $this->from . ', ' . $this->to . ', ' . $this->subject);
		} else {
			CakeLog::write('email', 'F, ' . $this->from . ', ' . $this->to . ', ' . $this->subject);
		}
